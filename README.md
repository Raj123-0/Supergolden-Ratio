...
Calculates Supergolden Ratio to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
Usage:
    python "Supergolden Ratio.py" -n 1000
